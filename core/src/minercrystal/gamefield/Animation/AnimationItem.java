...
public class AnimationItem {
    ...
    int SX1, SX2, SY1, SY2, Direction, count;
    public AnimationItem(int ModesSize,  Array<Array<Vector2>> Matrix, MovingHandler handler, double SPEED) {
    ...
    public void render(SpriteBatch batch, Array<Array<Item>> Items) {
        ...
        if (!isMoving && movedStop.size > 1) {
            for (Vector2 itemIndex : movedStop) {
                ...
                if (handler.destroyIfExistTheSame(SX1, SY1, SX2, SY2, Items))
                    count++;
            }
